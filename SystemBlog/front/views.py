...
def index(request):
    ...
    return render(request, 'index_f.html', {'resume': resume,
                                            'results': results,
                                            'articles': articles,
                                            'first': first},)
...
def list(request):
    ...
    articles = pg.page(page)
    return render(request, 'list_f.html', {'resume': resume,
                                           'results': results,
                                           'articles': articles,
                                           'articles1': articles1,
                                           'first': first},)
...
def infopic(request, id):
    ...
    return render(request, 'infopic_f.html', {'resume': resume,
                                              'results': results,
                                              'article': article
                                              })
...
def about(request):
    ...
    return render(request, 'about_f.html', {'results': results})
